function cambiarIdioma(lang) {
  const textos = {
    es: {
      ...
      nacimientoVal: "9 de diciembre de 2007.",
    ...
    pt: {
      ...
      nacimientoVal: "9 de dezembro de 2007.",
